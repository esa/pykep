...
/*                 or a surface point on an extended body such as a */
/*                 planet. OBSRVR is case-insensitive, and leading and */
...
/*     TRGEPC      is the "target surface point epoch." TRGEPC is */
/*                 defined as follows: letting LT be the one-way light */
/*                 time between the observer and the input surface point */
...
/*                 or omitted. LT is computed using the method indicated */
/*                 by ABCORR. */
...
/*         calling ILLUMF, the error will be diagnosed and signaled by a */
...
/*         loaded into the kernel pool prior to calling ILLUMF, the */
/*         error will be diagnosed and signaled by a routine in the call */
/*         tree of this routine. */
...
/*         orientation have not been loaded prior to calling ILLUMF, */
...
/*     1) Results from this routine are not meaningful if the input point */
/*        lies on a ridge or vertex of a surface represented by DSK data, */
/*        or if for any other reason the direction of the outward normal */
/*        vector at the point is undefined. */
