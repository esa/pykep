...
template<class T>
double propagate_taylor_disturbance_step(T& r0, T& v0, double &m0, const double &h, const int &order, const T &thrust, const T &disturbance, const double &mu, const double &veff, const double &xm, const double &eps_a, const double &eps_r, std::vector< boost::array<double,7> > &x, std::vector< boost::array<double,21> > &u){
 ...
 */
template<class T>
void propagate_taylor_disturbance(T& r0, T& v0, double &m0, const T& thrust, const T& disturbance, const double &t0, const double &mu = 1, const double &veff = 1, const int &log10tolerance=-10, const int &log10rtolerance=-10, const int &max_iter = 10000, const int &max_order = 3000){
    ...
    for (j=0; j< max_iter; ++j) {
        ...
        double h = propagate_taylor_disturbance_step(r0,v0,m0,step,order,thrust,disturbance,mu,veff,xm, eps_a, eps_r,_x,_u);
