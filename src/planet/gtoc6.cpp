...
gtoc6::gtoc6(const std::string &name)
{
    ...
    mapped_planets["io"] = 1;
    mapped_planets["europa"] = 2;
    mapped_planets["ganymede"] = 3;
    ...
    switch (mapped_planets[lower_case_name]) {
        case (1): {
            double E[6] = {422029687.14001,
                           4.308524661773E-03,
                           40.11548686966E-03 * ASTRO_DEG2RAD,
                           -79.640061742992 * ASTRO_DEG2RAD,
                           37.991267683987 * ASTRO_DEG2RAD,
                           286.85240405645 * ASTRO_DEG2RAD};
        ...
        case (2): {
            double E[6] = {671224237.12681,
                           9.384699662601E-03,
                           0.46530284284480 * ASTRO_DEG2RAD,
                           -132.15817268686 * ASTRO_DEG2RAD,
                           -79.571640035051 * ASTRO_DEG2RAD,
                           318.00776678240 * ASTRO_DEG2RAD};
            std::copy(E, E + 6, keplerian_elements_.begin());
            radius_ = 1561000.0;
            safe_radius_ = radius_ + 50000.0;
        ...
        case (3): {
            double E[6] = {1070587469.2374000,
                           1.953365822716E-03,
                           0.13543966756582 * ASTRO_DEG2RAD,
                           -50.793372416917 * ASTRO_DEG2RAD,
                           -42.876495018307 * ASTRO_DEG2RAD,
                           220.59841030407 * ASTRO_DEG2RAD};
            std::copy(E, E + 6, keplerian_elements_.begin());
            radius_ = 2634000.0;
            safe_radius_ = radius_ + 50000.0;
        ...
        case (4): {
            double E[6] = {1883136616.7305,
                           7.337063799028E-03,
                           0.25354332731555 * ASTRO_DEG2RAD,
                           86.723916616548 * ASTRO_DEG2RAD,
                           -160.76003434076 * ASTRO_DEG2RAD,
                           321.07650614246 * ASTRO_DEG2RAD};
            std::copy(E, E + 6, keplerian_elements_.begin());
            radius_ = 2408000;
            safe_radius_ = radius_ + 50000.0;
