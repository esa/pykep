...
conda install cmake ninja c-compiler cxx-compiler numpy "libboost>=1.73" "fmt>=10" "heyoka>=7" "heyoka.py>=7" spdlog "xtensor>=0.26" xtensor-blas pagmo-devel pybind11 pygmo sgp4 spiceypy matplotlib scipy "eigen>=3,<5" "nlopt<2.10.1"
