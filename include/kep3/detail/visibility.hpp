...
#ifndef kep3_DETAIL_VISIBILITY_HPP
#define kep3_DETAIL_VISIBILITY_HPP
...
#if defined(kep3_EXPORTS)

#define kep3_DLL_PUBLIC __declspec(dllexport)

#else

#define kep3_DLL_PUBLIC __declspec(dllimport)

#endif

#define kep3_DLL_LOCAL

#elif defined(__clang__) || defined(__GNUC__) || defined(__INTEL_COMPILER)

#define kep3_DLL_PUBLIC __attribute__((visibility("default")))
#define kep3_DLL_LOCAL __attribute__((visibility("hidden")))

#else

#define kep3_DLL_PUBLIC
#define kep3_DLL_LOCAL
...
#define kep3_DLL_PUBLIC_INLINE_CLASS kep3_DLL_PUBLIC
