...
zoh_reference_case make_reference_case()
{
    ...
    zoh_reference_case retval{
        .state0 = {rv0[0][0] / L, rv0[0][1] / L, rv0[0][2] / L, lp.get_v0()[0][0] / V, lp.get_v0()[0][1] / V,
                   lp.get_v0()[0][2] / V, m0 / MASS},
        .controls = {0.03 / F, 1.0, 0.0, 0.0, 0.02 / F, 1.0, 0.0, 0.0, 0.003 / F, 0.0, 1.0, 0.0,
                     0.03 / F, 1.0, 0.0, 0.0, 0.001 / F, 0.0, 0.0, 1.0},
        .state1 = {rv1[0][0] / L, rv1[0][1] / L, rv1[0][2] / L, lp.get_v1()[0][0] / V, lp.get_v1()[0][1] / V,
                   lp.get_v1()[0][2] / V, m1 / MASS},
        .tgrid = {},
        .cut = 0.5,
...
TEST_CASE("zoh_compute_throttle_constraints")
{
...
TEST_CASE("zoh_compute_mismatch_constraints")
{
    auto data = make_reference_case();
    kep3::leg::zoh leg{data.state0, data.controls, data.state1, data.tgrid, data.cut, data.ta};
    ...
    std::array<double, 7> const expected = {
        0.02176525074416702,
        -0.10717348832206364,
        -0.014802731334029318,
        0.14380114520228338,
        -0.04229446021128315,
        -0.004488343342410163,
        -0.05481446161533288,
    };
...
TEST_CASE("zoh_compute_mc_grad_reference")
{
    auto data = make_reference_case();
    ...
    std::vector<double> ref_dmc_dcontrols = {
        91.73476557268101, 0.45763200657108, -0.28135725774724, -0.01031907317353, 31.09418929737732, 0.10440792080321, -0.00533602707709, -0.00045457651689, 0.87488440350236, -0.01505254086631, 0.00044277737647, 0.00006261294551, -107.24705388291584, -0.54698571687815, 0.05053123459141, 0.0103081991757, 16.79209386337708, -0.05601179996783, -0.00413638005807, 0.00247869629428, -28.72309170977026, -0.14404629946369, 0.70835140389999, 0.01013584022919, -1.57360553816639, -0.00529368909715, 0.1014276654063, 0.00034130505513, -28.26664951403545, 0.00044565526668, -0.01430914720517, -0.00002930931036, 10.74724997022017, 0.05447548651581, -0.40260086656745, -0.00347096298556, -2.16537828966123, 0.00546872494741, -0.01561391615775, -0.00033912604726, -1.96983381789672, -0.00987971969853, 0.01846270259939, 0.30411337468551, -0.13517457261022, -0.00045468343358, 0.00034411567169, 0.09738982749413, -0.05758336979501, 0.00006266124429, -0.00002914289658, -0.01410234734889, 2.03676539391028, 0.01037027183734, -0.00324142530578, -0.38428189608695, -85.31665463779889, 0.00255640436003, 0.00023628798338, -0.01438546063671, 11.08043299892456, 0.05492934754674, -0.05849793618098, -0.00250935691183, 8.48706381330209, 0.02843898539217, -0.002592095189, -0.00024169665146, -0.51512924450038, 0.00408431229459, -0.00026073045229, -0.00003362758322, 12.53383288666958, 0.06395502800351, -0.01539836025854, -0.00252392862746, -2.17639178017643, 0.00552115654423, -0.00012445972877, -0.00032591005929, -6.12153308575359, -0.0306588627639, 0.07089021529296, 0.00205764362375, -0.7605391268277, -0.00255674650435, 0.02650220945787, 0.00016538098315, 7.33908456461765, -0.0002635557282, 0.00371640230435, 0.00001755508815, -3.39462214990647, -0.01723306474664, 0.03203446613325, 0.0011183595583, 0.7755171292174, -0.00200017859979, 0.00025122641828, 0.0001220302752, -0.48604398023409, -0.00243297443363, 0.00378558235203, 0.01741142675005, -0.07193614639063, -0.00024180730376, 0.00016774468822, 0.02471982711497, 0.03436097037797, -0.0000336749338, 0.00001739168815, 0.00358066335047, -0.50112854757231, -0.00255366494369, 0.00101179970477, 0.02496849363433, 0.9666097425291, -0.00034556512332, 0.00000895037566, 0.0001614547959, -3.86969447003105, 0.0, 0.0, 0.0, -3.86969447003105, 0.0, 0.0, 0.0, -3.86969447003105, -0.0, -0.0, -0.0, -3.86969447003106, -0.0, -0.0, -0.0, -3.86969447003105, -0.0, -0.0, -0.0 };
    std::vector<double> ref_dmc_dtgrid = {
        0.07525339735098, 0.01412034689889, 0.14380114520228, 0.04121585590418, -0.11047763236567, -0.16391311299066, 0.15640064005516, -0.00150248544324, -0.04229446021128, -0.00591789505836, 0.01413121620724, -0.12081701554951, -0.00701113187738, -0.00012100836737, -0.00448834334241, -0.00034239368632, 0.0051859488985, 0.00677692837499, -0.03602776627764, 0.00213308282678, 0.00459258866154, -0.00626861634219, 0.01154642401326, 0.02402428711826, 0.01851178663655, -0.00053649624179, -0.00054693897454, 0.00146647941931, -0.00389679114243, -0.0149980396971, 0.0020298538426, -0.00004823755368, 0.00001333345595, 0.00013904588755, -0.00068527212892, -0.0014487235035, 0.00256083519394, -0.00085361173131, -0.00145113994323, 0.00230475167454, -0.00247547402081, -0.00008536117313
    };
