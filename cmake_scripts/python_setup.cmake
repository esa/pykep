...
IF(NOT DEFINED PYKEP_PYTHON_FLAG)
	...
	IF(NOT DEFINED PYTHON_LIBRARY)
		EXECUTE_PROCESS ( COMMAND ${PYTHON_EXECUTABLE} "${CMAKE_SOURCE_DIR}/cmake_scripts/find_python_library.py" OUTPUT_VARIABLE PYTHON_LIBRARY OUTPUT_STRIP_TRAILING_WHITESPACE)
...
MESSAGE(STATUS "Python library name: "         "${PYTHON_LIBRARY}")
...
SET(PYTHON_LIBRARY ${PYTHON_LIBRARY} CACHE PATH "Name of the python library")
