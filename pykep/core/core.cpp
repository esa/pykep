...
static inline tuple closest_distance_wrapper(const kep_toolbox::array3D &r0,
                                             const kep_toolbox::array3D &v0,
                                             const kep_toolbox::array3D &r1,
                                             const kep_toolbox::array3D &v1,
                                             const double &mu) {
  double min_d, ra;
...
static inline tuple propagate_lagrangian_wrapper(const kep_toolbox::array3D &r0,
                                                 const kep_toolbox::array3D &v0,
                                                 const double &t,
                                                 const double &mu) {
...
static inline tuple propagate_taylor_wrapper(
  ...
  kep_toolbox::array3D r(r0), v(v0);
  double m(m0);
  kep_toolbox::propagate_taylor(r, v, m, u, t, mu, veff, log10tolerance,
                                log10rtolerance);
...
static inline tuple propagate_taylor_J2_wrapper(
  ...
  kep_toolbox::array3D r(r0), v(v0);
  double m(m0);
  kep_toolbox::propagate_taylor_J2(r, v, m, u, t, mu, veff, J2RG2,
...
static inline tuple propagate_taylor_s_wrapper(
  ...
  double m(m0);
  double dt(0);
  kep_toolbox::propagate_taylor_s(r, v, m, dt, u, s, mu, veff, c, alpha,
                                  log10tolerance, log10rtolerance);
  return boost::python::make_tuple(
      kep_toolbox::array3D(r), kep_toolbox::array3D(v), double(m), double(dt));
}

static inline tuple fb_con_wrapper(const kep_toolbox::array3D &vin_rel,
                                   const kep_toolbox::array3D &vout_rel,
...
static inline kep_toolbox::array3D
fb_prop_wrapper(const kep_toolbox::array3D &v_in,
                const kep_toolbox::array3D &v_pla, const double &rp,
...
static inline double fb_vel_wrapper(const kep_toolbox::array3D &vin_rel,
                                    const kep_toolbox::array3D &vout_rel,
                                    const kep_toolbox::planet::base &pl) {
  double dV(0);
...
static inline tuple damon_wrapper(const kep_toolbox::array3D &v1,
                                  const kep_toolbox::array3D &v2, double tof) {
  kep_toolbox::array3D a1, a2;
  double tau, dv;
  kep_toolbox::damon_approx(v1, v2, tof, a1, a2, tau, dv);
  return boost::python::make_tuple(kep_toolbox::array3D(a1),
                                   kep_toolbox::array3D(a2), double(tau),
                                   double(dv));
}

#define get_constant(arg)                                                      \
  static inline double get_##arg() { return ASTRO_##arg; }
...
BOOST_PYTHON_MODULE(_core) {
  ...
  PYKEP_REGISTER_CONVERTER(std::vector<kep_toolbox::array3D>,
  ...
  // Epoch class
  class_<kep_toolbox::epoch>(
      "epoch", "Represents a precise point in time. The "
  ...
  class_<kep_toolbox::lambert_problem>(
      ...
      init<optional<const kep_toolbox::array3D &, const kep_toolbox::array3D &,
      ...
      .def(
          "get_v1", &kep_toolbox::lambert_problem::get_v1,
          ...
          "  v10 = l.get_v1()[0]")
      .def(
          "get_v2", &kep_toolbox::lambert_problem::get_v2,
          return_value_policy<copy_const_reference>(),
          ...
          "  v20 = l.get_v2()[0]")
      .def("get_r1", &kep_toolbox::lambert_problem::get_r1,
           return_value_policy<copy_const_reference>(),
           "Returns a vector containing the r1 defining the Lambert's "
           "Problem\n\n"
           "Example ::\n\n"
           "  r1 = l.get_r1()")
      .def("get_r2", &kep_toolbox::lambert_problem::get_r2,
           return_value_policy<copy_const_reference>(),
           "Returns a vector containing the r2 defining the Lambert's "
           "Problem\n\n"
           "Example ::\n\n"
           "  r2 = l.get_r2()")
      .def("get_tof", &kep_toolbox::lambert_problem::get_tof,
           return_value_policy<copy_const_reference>(),
           "Returns the time of flight defining the Lambert's Problem\n\n"
           "Example::\n\n"
           "  t = l.get_tof()")
      .def("get_mu", &kep_toolbox::lambert_problem::get_mu,
           return_value_policy<copy_const_reference>(),
           ...
           "  mu = l.get_mu()")
      .def(
          "get_x", &kep_toolbox::lambert_problem::get_x,
          return_value_policy<copy_const_reference>(),
          ...
          "  x0 = l.get_x()[0]")
      .def(
          "get_iters", &kep_toolbox::lambert_problem::get_iters,
          return_value_policy<copy_const_reference>(),
  ...
  */
  ...
  double (*three_imp)(double, double, double, double, double, double, double,
                      double, double) = &kep_toolbox::three_impulses_approx;
  double (*three_imp_2_pl)(const kep_toolbox::planet::base &,
                           const kep_toolbox::planet::base &) =
      &kep_toolbox::three_impulses_approx;
  double (*three_imp_2_pl_2_ep)(
      const kep_toolbox::planet::base &, const kep_toolbox::planet::base &,
